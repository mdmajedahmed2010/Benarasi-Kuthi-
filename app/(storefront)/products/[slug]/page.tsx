    ...
    if (demoProduct) {
      productRes = {
        ...
        product: {
          ...
          description: demoProduct.name + " - Premium Benarasi Saree Collection",
          basePrice: demoProduct.price,
          category: {
            name: demoProduct.category || "Saree",
            slug: (demoProduct.category || "Saree").toLowerCase().replace(/ /g, "-"),
          },
          variants: [
            {
