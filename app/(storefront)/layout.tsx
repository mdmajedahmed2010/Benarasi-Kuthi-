  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#fdfaf5] px-4 text-center">
      <div className="max-w-md w-full space-y-6">
        <div className="inline-flex h-16 w-16 items-center justify-center rounded-full bg-[#5c061c]/10 text-[#5c061c] mb-2">
        ...
        <p className="text-muted-foreground text-sm leading-relaxed">
          Benarasi Kuthi is currently undergoing scheduled updates to provide you with a more premium shopping
        ...
        <div className="pt-6 border-t border-[#d4af37]/30 text-xs text-muted-foreground">
          <p>© {new Date().getFullYear()} Benarasi Kuthi. All rights reserved.</p>
        </div>
      </div>
    </div>
  );
