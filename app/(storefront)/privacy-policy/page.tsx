/**
 * Benarasi Kuthi — Privacy Policy (v1.0)
 * বেনারসী কুঠি | Mirpur Benaroshi Polli, Dhaka
 * New page — not existed before
 */
...
export const metadata: Metadata = {
  title: "Privacy Policy — Benarasi Kuthi | বেনারসী কুঠি",
  description:
    "বেনারসী কুঠির Privacy Policy। আমরা আপনার ব্যক্তিগত তথ্যের নিরাপত্তাকে সর্বোচ্চ গুরুত্ব দিই।",
};
...
আমরা কোনো Payment Card তথ্য, জাতীয় পরিচয়পত্র বা অন্য সংবেদনশীল তথ্য সংগ্রহ করি না।`,
  },
  {
    id: "02",
...
শুধুমাত্র Delivery Partner (Courier Service) আপনার ঠিকানা ও ফোন নম্বর পায় — শুধুমাত্র পণ্য পৌঁছে দেওয়ার জন্য।`,
  },
  {
    id: "04",
    title: "Cookies ও Website Analytics",
    content: `আমাদের ওয়েবসাইটে আপনার অভিজ্ঞতা উন্নত করতে আমরা Cookies ব্যবহার করতে পারি। এতে Shopping Cart তথ্য সংরক্ষিত থাকে।

আমরা Website Traffic বোঝার জন্য Anonymous Analytics ব্যবহার করি — এতে কোনো ব্যক্তিগত তথ্য থাকে না।`,
  },
  {
    id: "05",
...
• আমাদের কাছে থাকা আপনার তথ্য দেখার অধিকার
...
এই বিষয়ে আমাদের Facebook Inbox বা ইমেইলে যোগাযোগ করুন।`,
  },
  {
    id: "08",
    title: "Policy আপডেট",
    content: `আমরা এই Privacy Policy যেকোনো সময় আপডেট করতে পারি। গুরুত্বপূর্ণ পরিবর্তন হলে আমরা Facebook Page-এ জানাব।
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white border border-[#e8e0d0] rounded-sm p-6 md:p-8 mb-8 border-l-4 border-l-[#d4af37]">
            <p className="text-sm text-muted-foreground leading-relaxed">
              বেনারসী কুঠি (Benarasi Kuthi) আপনার গোপনীয়তাকে সম্মান করে। এই Privacy Policy
          ...
          <div className="space-y-5 mb-12">
            {privacySections.map((section) => (
              <div
                key={section.id}
                className="bg-white border border-[#e8e0d0] rounded-sm p-6 border-l-4 border-l-[#5c061c]"
              >
          ...
          <div className="bg-[#f7f0e8] rounded-sm p-6 text-center border border-[#d4af37]/20">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              ...
              <a
                ...
                className="inline-flex items-center justify-center h-11 px-6 border-2 border-[#5c061c]/30 text-[#5c061c] text-sm font-semibold rounded-sm hover:bg-[#5c061c]/5 hover:border-[#5c061c] transition-all"
              >
                {BUSINESS.EMAIL}
              </a>
            </div>
          ...
          <div className="flex items-center justify-center gap-6 text-xs text-muted-foreground pt-8">
            <Link href="/terms" className="hover:text-[#5c061c] transition-colors font-medium">
              Terms & Conditions
            </Link>
