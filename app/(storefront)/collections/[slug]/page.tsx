...
export default async function CollectionPage({ params, searchParams }: CollectionPageProps) {
  ...
  return (
    <div className="container mx-auto px-6 md:px-8 py-6 md:py-10 max-w-[1280px]">
      ...
      <div className="mt-6 mb-10 bg-[#5c061c] text-[#d4af37] p-8 md:p-12 rounded-sm border border-[#d4af37]/30 shadow-md text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto">
          <p className="text-[10px] font-bold uppercase tracking-[0.2em] mb-3 text-[#d4af37]/80">
            Benarasi Kuthi Exclusive
          </p>
          <h1 className="text-3xl md:text-5xl font-bold tracking-wide font-serif mb-4">
            {categoryName}
          </h1>
          <p className="text-sm md:text-[15px] text-[#fdfaf5]/90 leading-relaxed font-light">
            {categoryDescription}
          </p>
        </div>
      </div>
