/**
 * BIBAZ — All Categories Page (DATABASE-DRIVEN)
 * Route: /categories
 */
...
export const metadata: Metadata = {
  title: "All Categories — BIBAZ",
  description:
    "Browse all BIBAZ clothing categories — Kaftans, Cord Sets, Abayas, Capes, Kamij Sets, Sharis and more.",
};
    ...
    <div className="min-h-screen bg-[#fdfcfa]">
      <div className="container mx-auto px-4 py-8 md:py-12 max-w-7xl">
        ...
        <div className="mt-10 mb-14 text-center">
          <span className="inline-block px-3.5 py-1 rounded-full border border-[#5c061c]/50 bg-[#5c061c]/5 text-[#5c061c] text-[10px] uppercase tracking-[0.28em] font-bold mb-4">
            ✦ BENARASI KUTHI EXCLUSIVE ✦
          </span>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-[#5c061c] font-serif">
            All Categories
          </h1>
          ...
          <p className="text-neutral-600 mt-4 text-sm md:text-base max-w-xl mx-auto font-sans">
            Explore our complete range of categories curated for bridal trousseau, festive celebrations, and everyday luxury.
          </p>
        </div>
