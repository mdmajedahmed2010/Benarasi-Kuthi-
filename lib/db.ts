        ...
        get(modelTarget, modelProp) {
          ...
          return async (...args: any[]) => {
            ...
            if (prop === "siteSetting" && modelProp === "findUnique") {
              ...
              if (whereKey === "store_logo") return { key: "store_logo", value: "/images/logo/348254398_927747708509948_4192295653740697805_n.jpg" };
            }
            if (prop === "siteSetting" && modelProp === "findMany") {
              return [
                { key: "store_name", value: "Benarasi Kuthi" },
                { key: "store_phone", value: "+880 1971-380319" },
                { key: "store_email", value: "info@benarasikuthi.com" },
                { key: "store_address", value: "House-17, Section-10, Block-A, Lane-7, Mirpur Benaroshi Polli, Dhaka-1221" },
                { key: "shipping_dhaka", value: "80" },
                { key: "shipping_outside", value: "150" },
                { key: "social_facebook", value: "https://www.facebook.com/benarasikuthi/?locale=en_GB" },
              ];
            }
