              ...
              <div className="container mx-auto px-6 md:px-12 lg:px-16">
                ...
                >
                  ...
                  <div className="flex items-center gap-3 mb-5">
                    <span
                      className={`h-[1.5px] bg-[#c9a96e] transition-all duration-700 delay-500 ${
                        isActive && heroReady ? "w-10" : "w-0"
                      }`}
                    />
                    <span
                      className={`inline-block px-3.5 py-1 rounded-full border border-[#c9a96e]/50 bg-[#0f0e0d]/60 backdrop-blur-md text-[#e8ce9e] text-[10px] md:text-xs uppercase tracking-[0.28em] font-bold transition-all duration-700 delay-500 shadow-sm ${
                        isActive && heroReady
                  ...
                  {/* Title */}
                  <h1
                    className={`text-[34px] sm:text-[48px] md:text-[60px] lg:text-[72px] font-bold text-white leading-[1.04] tracking-tight mb-5 font-heading drop-shadow-md transition-all duration-[800ms] delay-[400ms] ${
                      isActive && heroReady
                        ? "opacity-100 translate-y-0"
                  ...
                  <p
                    className={`text-xs sm:text-sm md:text-base text-neutral-200 max-w-lg leading-relaxed mb-8 md:mb-10 font-medium font-sans transition-all duration-[800ms] delay-[600ms] ${
                      isActive && heroReady
                        ? "opacity-100 translate-y-0"
                  ...
                  >
                    <Link
                      href={slide.link}
                      className="relative inline-flex items-center justify-center gap-2.5 h-13 md:h-14 px-9 bg-white hover:bg-[#e8ce9e] text-[#0f0e0d] text-xs font-bold uppercase tracking-[0.2em] transition-all duration-300 rounded-sm shadow-luxury hover:shadow-gold-glow active:scale-[0.98] group/btn cursor-pointer border border-white/20 overflow-hidden"
                    >
                      {/* CTA shimmer overlay */}
                      <span className="absolute inset-0 -translate-x-full group-hover/btn:translate-x-full transition-transform duration-700 bg-gradient-to-r from-transparent via-[#c9a96e]/20 to-transparent pointer-events-none" />
                      Shop Collection
      ...
      <div className="absolute bottom-0 left-0 right-0 z-30">
        ...
        <div className="relative h-[2px] bg-white/10">
          <motion.div
            ...
            className="absolute left-0 top-0 h-full bg-gradient-to-r from-[#c9a96e] to-[#e8ce9e]"
          />
        </div>
