    ...
    >
      ...
      <div className="relative aspect-[3/4] overflow-hidden bg-neutral-100 mb-3 md:mb-4">
        ...
        <div className="absolute top-3 left-3 flex flex-col gap-1.5 z-10">
          {isBestseller && (
            <span className="inline-flex items-center px-2.5 py-0.5 bg-[#d4af37] text-[#5c061c] text-[9px] font-bold uppercase tracking-[0.15em] rounded-sm shadow-sm">
              ★ Bestseller
            </span>
          )}
          {isNew && !isBestseller && (
            <span className="inline-flex items-center px-2.5 py-0.5 bg-[#5c061c] text-white text-[9px] font-bold uppercase tracking-[0.15em] rounded-sm shadow-sm">
              New
            </span>
          )}
          {hasDiscount && (
        ...
        {!isSoldOut && (
          <button
            ...
            className="absolute bottom-3 right-3 z-20 flex items-center justify-center h-10 w-10 rounded-full bg-white/95 text-[#5c061c] border border-[#d4af37]/40 hover:bg-[#5c061c] hover:text-[#d4af37] hover:border-[#5c061c] shadow-[0_4px_12px_rgba(0,0,0,0.08)] transition-all duration-300 cursor-pointer backdrop-blur-[1px] transform md:translate-y-2 md:opacity-0 md:group-hover:translate-y-0 md:group-hover:opacity-100 md:focus:translate-y-0 md:focus:opacity-100"
            title="Quick View"
          >
      ...
      <div className="space-y-1">
        ...
        {/* Product name */}
        <h3 className="text-[13px] md:text-[14px] font-medium leading-snug text-[#0f0e0d] line-clamp-2 transition-colors duration-300 group-hover:text-[#5c061c] font-serif">
          {name}
        </h3>
