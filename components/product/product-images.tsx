    ...
    <div className="w-full space-y-4">
      ...
      <div className="flex flex-col-reverse md:flex-row gap-4">
        ...
        >
          ...
          <div className="absolute bottom-4 right-4 bg-[#5c061c]/90 backdrop-blur-md px-3.5 py-2 rounded-full shadow-sm opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0 flex items-center gap-2 text-[#d4af37] text-xs font-bold uppercase tracking-widest">
            <span>Expand</span>
