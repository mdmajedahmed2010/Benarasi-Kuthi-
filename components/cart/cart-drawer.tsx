      ...
      >
                ...
                <div
                  ...
                  style={{
                    ...
                    background: progress >= 100
                      ...
                      : "linear-gradient(90deg, #c9a96e, #e8ce9e)"
                  }}
                />
              </div>
            </div>
        ...
        {items.length === 0 ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center gap-6 text-center py-10">
            ...
            <button
              onClick={closeCart}
              className="inline-flex items-center justify-center h-11 px-8 border border-[#5c061c] bg-transparent text-[#5c061c] text-xs font-bold uppercase tracking-wider hover:bg-[#5c061c] hover:text-[#d4af37] transition-all duration-300 cursor-pointer rounded-sm"
            >
              Start Shopping
            </button>
          </div>
                ...
                <div className="space-y-2">
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="h-9 px-4 bg-[#5c061c] text-[#d4af37] text-[10px] font-bold uppercase tracking-[0.15em] hover:bg-[#4a0516] transition-all disabled:opacity-50 cursor-pointer whitespace-nowrap rounded-r-sm shrink-0"
                    >
            ...
            <div className="pt-2 space-y-4">
              ...
              <div className="space-y-2 mt-4">
                ...
                <Link
                  href="/checkout"
                  onClick={closeCart}
                  className="relative flex items-center justify-center w-full h-12 bg-[#5c061c] text-[#d4af37] font-bold text-xs uppercase tracking-[0.2em] hover:bg-[#4a0516] transition-all duration-300 overflow-hidden group/checkout rounded-sm shadow-sm"
                >
