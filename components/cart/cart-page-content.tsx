    ...
    return (
      <div className="flex flex-col items-center justify-center py-20 gap-6 text-center max-w-md mx-auto">
        ...
        <Link
          ...
          className="inline-flex items-center justify-center h-12 px-8 bg-[#5c061c] text-[#d4af37] text-xs font-bold uppercase tracking-wider hover:bg-[#4a0516] transition-all duration-300 rounded-sm"
        >
          Start Shopping
        </Link>
      </div>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
      ...
      <div className="lg:col-span-4">
        <div className="sticky top-28 bg-[#fdfaf5] border border-[#d4af37]/30 shadow-md rounded-sm p-8 space-y-6">
          <h2 className="text-xs font-bold uppercase tracking-[0.2em] text-[#5c061c]">
            Order Summary
          </h2>
          ...
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 h-11 px-4 border border-[#d4af37]/60 bg-white text-xs tracking-wider placeholder:text-muted-foreground focus:outline-none focus:border-[#5c061c] uppercase font-semibold rounded-sm"
            />
            <button className="h-11 px-6 bg-[#5c061c] text-white text-xs font-bold uppercase tracking-wider hover:bg-[#4a0516] transition-colors cursor-pointer rounded-sm">
              Apply
            </button>
          </div>
          ...
          <div className="space-y-2 pt-2">
            ...
            <Link
              href="/checkout"
              className="flex items-center justify-center w-full h-12 bg-[#5c061c] text-[#d4af37] font-bold text-xs uppercase tracking-[0.2em] hover:bg-[#4a0516] shadow-sm hover:shadow-md transition-all duration-300 rounded-sm"
            >
              Proceed to Checkout
            </Link>
            ...
            <Link
              href="/collections/new-arrivals"
              className="flex items-center justify-center w-full h-11 border border-[#5c061c]/30 bg-transparent text-[#5c061c] hover:bg-[#5c061c]/5 text-xs font-bold uppercase tracking-[0.15em] transition-all duration-300 rounded-sm"
            >
              Continue Shopping
            </Link>
          </div>
