...
export function CheckoutForm({ settings = {} }: { settings?: Record<string, any> }) {
  ...
  useEffect(() => {
    ...
    const customNote = localStorage.getItem("bibaz_pending_custom_note");
    if (customNote) {
      setTimeout(() => {
        setNote(customNote);
      }, 0);
    ...
    return (
      <div className="flex flex-col items-center justify-center py-20 gap-6 text-center max-w-md mx-auto animate-scale-in">
        ...
        <Link
          ...
          className="inline-flex items-center justify-center h-12 px-8 bg-[#5c061c] hover:bg-[#4a0516] text-[#d4af37] text-xs font-bold uppercase tracking-widest transition-all duration-300 rounded-sm active:scale-95 shadow-md"
        >
          Start Shopping
        </Link>
      </div>
    ...
    return (
      <div className="max-w-2xl mx-auto text-center py-12 px-6 space-y-7 border border-[#d4af37]/30 bg-[#fdfaf5] shadow-[0_12px_40px_rgba(0,0,0,0.03)] rounded-lg animate-scale-in">
        ...
        <div className="space-y-3">
          ...
          <p className="text-xs text-[#5c061c] uppercase tracking-widest max-w-md mx-auto leading-relaxed font-bold">
            Thank you for choosing Benarasi Kuthi. Our customer support team will call you shortly to confirm
            your delivery.
          </p>
        </div>
        ...
        <div className="p-5 bg-white border border-[#e8e0d0] rounded-lg max-w-md mx-auto space-y-4 shadow-sm">
          ...
          <div className="flex justify-between items-center text-xs">
            ...
            <span className="font-bold text-[#5c061c] text-sm">{formatPrice(confirmedTotal)}</span>
          </div>
        </div>
        ...
        <div className="pt-4 max-w-md mx-auto space-y-3">
          <Link
            href="/track-order"
            className="flex items-center justify-center w-full h-12 bg-[#5c061c] text-[#d4af37] text-xs font-bold uppercase tracking-[0.2em] hover:bg-[#4a0516] transition-all duration-300 rounded-sm active:scale-95 shadow-md"
          >
            Track Order Status
          </Link>
          <Link
            href="/"
            className="flex items-center justify-center w-full h-11 border border-[#5c061c]/30 bg-white text-[#5c061c] hover:bg-[#5c061c]/5 text-xs font-bold uppercase tracking-[0.15em] transition-all duration-300 rounded-sm"
          >
            Continue Shopping
          </Link>
        </div>
  ...
  return (
    ...
    >
      ...
      <div className="lg:col-span-7 space-y-8">
        ...
        <div className="bg-[#f7eded] border border-[#5c061c]/20 rounded-sm p-4">
          <h3 className="text-[11px] font-bold text-[#5c061c] uppercase tracking-wider mb-2 flex items-center gap-1.5">
            <CheckCircle2 className="h-4 w-4 text-[#5c061c]" /> Delivery & Return Policy
          </h3>
      ...
      <div className="lg:col-span-5">
        <div className="sticky top-28 bg-[#fdfaf5] border border-[#d4af37]/30 p-6 md:p-8 rounded-lg shadow-md space-y-6">
              ...
              <div className="space-y-3.5">
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="h-10 px-4 bg-[#5c061c] hover:bg-[#4a0516] text-[#d4af37] text-[10px] font-bold uppercase tracking-[0.15em] transition-all disabled:opacity-50 cursor-pointer whitespace-nowrap rounded-sm shadow-sm"
                  >
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <button
                      ...
                      className="text-[9px] font-mono font-bold px-2.5 py-1 bg-white border border-dashed border-[#d4af37] text-[#5c061c] hover:bg-[#5c061c]/5 rounded-xs transition-all shadow-3xs cursor-pointer active:scale-95"
                    >
                      BIBAZ10 (10% OFF)
                    </button>
                    <button
          ...
          <button
            ...
            className="flex items-center justify-center w-full h-13 bg-[#5c061c] hover:bg-[#4a0516] text-[#d4af37] font-bold text-xs uppercase tracking-[0.2em] transition-all duration-300 disabled:opacity-40 cursor-pointer shadow-md rounded-sm active:scale-98 animate-pulse-glow"
          >
